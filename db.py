...
cursor.execute("INSERT INTO Products VALUES"
                                "('Whopper', 5.39, 'Burger_1.png'),"
                                "('Imposible Whopper', 6.39, 'Burger_2.png'),"
                                "('Double Whopper', 6.59, 'Burger_3.png'),"
                                "('Triple Whopper', 7.79, 'Burger_4.png'),"
                                "('Bacon king', 6.49, 'Burger_5.png'),"
                                "('Single Quarter Pound King', 5.49, 'Burger_6.png'),"
                                "('Single Impossible King', 6.49, 'Burger_7.png'),"
                                "('BBQ Bacon Whopper Jr.', 3.89, 'Burger_8.png'),"
                                "('Whopper Jr.', 3.29, 'Burger_9.png'),"
                                "('Big King', 4.19, 'Burger_10.png'),"
                                "('Bacon Double Cheeseburger', 3.59, 'Burger_11.png'),"
                                "('Bacon Cheeseburger', 2.49, 'Burger_12.png'),"
                                "('Double Cheeseburger', 2.99, 'Burger_13.png'),"
                                "('Cheeseburger', 1.99, 'Burger_14.png'),"
                                "('Rodeo Burger', 1.79, 'Burger_15.png'),"
                                "('Hamburger', 1.79, 'Burger_16.png'),")

cursor.execute("INSERT INTO Products VALUES"
                                "('BK Royal Crispy Chicken', 5.39, 'Chicken_1.png'),"
                                "('Spicy BK Royal Crispy Chicken', 5.89, 'Chicken_2.png'),"
                                "('Bacon and Swiss BK Royal Crispy Chicken', 6.79, 'Chicken_3.png'),"
                                "('Honey Mustard BK Royal Crispy Chicken', 6.79, 'Chicken_4.png'),"
                                "('Original Chicken Sandwich', 4.99, 'Chicken_5.png'),"
                                "('Chicken Jr.', 1.59, 'Chicken_6.png'),"
                                "('Big Fish', 4.69, 'Chicken_7.png'),"
                                "('Classic BK Royal Crispy Wrap.', 2.99, 'Chicken_8.png'),"
                                "('Spicy BK Royal Crispy Wrap', 2.99, 'Chicken_9.png'),"
                                "('Honey Mustard BK Royal Crispy Wrap', 2.99, 'Chicken_10.png'),")
